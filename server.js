...
let server = http.createServer((req, res)=>{
    ...
    else if(req.url.startsWith("/dis like") && req.method == "GET"){
        dislikePost(req, res)
    }
    else{
...
function likePost(req, res){
    ...
    console.log(params)
    let pathToJokes = path.join(__dirname, "static", "data", params.id + ".json")
    let joke = fs.readFileSync(pathToJokes)
    ...
    fs.writeFileSync(pathToJokes, joke)
